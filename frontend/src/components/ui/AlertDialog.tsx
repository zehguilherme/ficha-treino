...
const AlertDialogFooter = ({
  ...
  <div className={cn('flex flex-col gap-2 pt-2 sm:flex-row-reverse', className)} {...props} />
);
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ref={ref}
    className={cn(
      'pointer-events-auto inline-flex h-10 items-center justify-center rounded-[var(--radius)] border border-border px-4 text-sm font-medium outline-none transition-colors hover:bg-secondary focus-visible:ring-2 focus-visible:ring-ring disabled:cursor-not-allowed disabled:opacity-50',
      className,
    )}
    {...props}
  />
