...
2026-09-08 — issue #171 — rotas de páginas autenticadas passaram a usar segmentos em português (`/treinos`, `/treinos/[dia]/adicionar-exercicio` e `/minha-conta`); `/login` e `/auth/google/callback` permanecem estáveis e as URLs antigas não têm compatibilidade.
